...
"""Provides the task panel code for the LandXML Subtask tool."""

from FreeCAD import Vector

from ..geoutils.alignment_importer import AlignmentImporter
from ..utils import widget_model, units
from ..utils.utils import Constants as C
from ..geoutils import support


class LandXMLSubtask:
    """
