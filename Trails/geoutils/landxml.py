...
def get_child_as_vector(node, node_name, delimiter=' '):
    """
    Return the first child matching node_name in node as FreeCAD.Vector
    """
    ...
    return FreeCAD.Vector(vec_list)
...
def build_vector(coords):
    """
    Returns an FreeCAD.Vector of the passed coordinates,
    ...
    return FreeCAD.Vector(float_coords)
