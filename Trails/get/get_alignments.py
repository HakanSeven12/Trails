...
"""Provides functions to get Alignment group."""
...
def get():
    """
    Find the existing Alignment group.
    """
    # Return an existing instance of the same name, if found.
    obj = FreeCAD.ActiveDocument.getObject('Alignments')
...
def create():
    ...
    obj.Label = "Alignments"
    obj.Proxy.Type = "Trails::Alignments"
    obj.ViewObject.Proxy.Icon = icons_path + '/Alignment.svg'
